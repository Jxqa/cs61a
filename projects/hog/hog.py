...
def is_swap(player_score, opponent_score):
    ...
    # BEGIN PROBLEM 4
    "*** YOUR CODE HERE ***"
    if opponent_score < 100 and abs((player_score % 10) - (opponent_score % 10)) == opponent_score // 10:
        return True
    elif opponent_score >= 100 and abs((player_score % 10) - (opponent_score % 10)) == opponent_score % 100 // 10:
        return True
    else:
        return False
    # END PROBLEM 4
...
def play(strategy0, strategy1, score0=0, score1=0, dice=six_sided,
    ...
    while score0 < goal and score1 < goal:
        if who == 0:
            ...
            if feral_hogs and abs(num_rolls - last_turn_score0) == 2:
                score0 += 3
            ...
            if feral_hogs and abs(num_rolls - last_turn_score1) == 2:
                score1 += 3
...
def max_scoring_num_rolls(dice=six_sided, trials_count=1000):
    ...
    while i <= 10:
        ...
        current_high = averaged_dice(i, dice)
        if current_high > ave_high:
            ave_high = current_high
            k = i
        i += 1
    return k
    # END PROBLEM 9
