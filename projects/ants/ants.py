...
class ThrowerAnt(Ant):
    ...
    def nearest_bee(self, beehive):
        ...
        place = self.place
        curr_range = 0
        while curr_range < self.min_range and place is not beehive:
            place = place.entrance
            curr_range += 1
        while curr_range <= self.max_range and place is not beehive:
            if len(place.bees) > 0:
                break
            place = place.entrance
            curr_range += 1
        if place is beehive or curr_range > self.max_range:
            return None
...
class ContainerAnt(Ant):
    ...
    def can_contain(self, other):
        # BEGIN Problem 9
        "*** YOUR CODE HERE ***"
        return True if self.contained_ant is None and not isinstance(other, ContainerAnt) else False
        # END Problem 9
        ...
        if self.impostor:
            ...
            while curr_place is not None:
                ...
                and not curr_place.ant.contained_ant.buffed:
                    curr_place.ant.contained_ant.damage = curr_place.ant.contained_ant.damage*2
...
class Bee(Insect):
    ...
    def blocked(self):
        ...
        # BEGIN Problem 7
        return False if self.place.ant == None or self.place.ant.blocks_path == False else True
        # END Problem 7
